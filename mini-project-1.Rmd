---
title: "Mini Data-Analysis Deliverable 1 - Negar Zaghi"
output: 
  md_document:
...
_I will choose vancouver_trees because I am interested to learn more about them._
...
_I want to explore a map of what types of trees are in which areas of Vancouver..._
...
_Here, a new variable is added, age of trees in years._
_This utilizes the date planted and subtracts it by today's date and converts that value (in days) to years_
_A new tibble is created with only some columns of interest_
...
_Here, we explore the relationship between the  age of tree and the diameter_
_We see that there is not a significant relationship_
```{r}
...
## 4) Mapping
_Here, we are mapping the trees based on latitude and longitude_
_Using colour, we can see the height ranges and whether the tree is by a curb or not_
```{r}
...
_This plot uses a jitter plot to show the distribution of tree diameter for each height range ID_
```{r}
...
Research Question 1: For each genus, what common names of trees are found in Vancouver?

Research Question 2: Is there a relationship between the height of trees and the age of trees? What about the diameter of tree against the age of trees?

Research Question 3: Where are the different type of tree located in Vancouver? Is there a trend between location of tree planted and type of tree?

Research Question 4: Is there a relationship between the height of trees and the diameter of trees
